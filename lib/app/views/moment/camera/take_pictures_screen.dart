...
// A screen that allows users to take a picture using a given camera.// A screen that allows users to take a picture using a given camera.
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        IconButton(icon: SvgPicture.asset(Assets.icons.adduser), onPressed: () {},), // TODO: Chuyển đến màn thêm bạn bè
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: SvgPicture.asset(Assets.icons.vector),
                      onPressed: () {setState(() {
